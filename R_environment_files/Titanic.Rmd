...
$$
H_0 \text{: La variable se distribuye como una normal.}  
$$
$$
H_1 \text{: La varaible no se distribuye como una normal.}  
$$
...
$$
H_0 \text{: No hay diferencias significativas entre las varianzas.}  
$$
$$
H_1 \text{: Hay diferencias significativas entre las varianzas}  
$$
...
donde, $\mu$ representa la media poblacional, 1 corresponde al conjunto que sobrevivió y 2 al que no sobrevivió.
